...
meta:
	ADDON_NAME = ofxParticleField
	ADDON_DESCRIPTION = A particle implementation where forces are applied from a vector field
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon" "particles"
	ADDON_URL = http://github.com/smeyfroi/ofxParticleField

common:
	# dependencies with other addons, a list of them separated by spaces
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxRenderer
